            ...
            <SectionHeader
                ...
                description={
                    !hasPortfolio
                        ...
                        : isPaper
                            ? "Your paper desk — virtual funds, real prices. Connect an exchange for live equity."
                            : "Account equity, allocation, and lifetime performance"
                }
            />

            {!hasPortfolio && !hasRealized ? (
                <Card>
                    <EmptyState
                        icon={<Wallet />}
                ...
                <>
                    {/* Account equity + allocation (seeded paper, or live once connected) */}
                    {hasPortfolio && (
                    ...
                    {/* Realized performance from settled trades */}
                    {hasRealized ? (
                        <>
                        ...
                        <Card className="py-8">
                            <EmptyState
                                ...
                                description={
                                    isPaper
                                        ? "Your paper trades will appear here once the AI engine runs and positions settle."
                                        : "Closed positions and realized P&L will appear here as trades settle."
                                }
                            />
                        </Card>
                    )}
