    ...
    return (
        <section className="relative overflow-hidden pt-36 pb-14 md:pt-44 md:pb-16">
            ...
            <motion.div
                ...
                className="pointer-events-none absolute inset-y-0 right-0 z-0 hidden w-[74%] select-none lg:block"
                style={{
                    perspective: "1800px",
            ...
            >
                ...
                >
                    <div
                        className="absolute right-0 top-[58%] w-[1080px] max-w-none opacity-[0.88]"
                        style={{
                            transform:
